...
keywords given a video theme and slide title + body text.
"""
...
- For theme "coldest countries" + title "Siberia" + body "Oymyakon village": frozen landscape, snow tundra, siberia winter, icy village
- For theme "tallest buildings" + title "Burj Khalifa" + body "Located in Dubai": burj khalifa, dubai skyscraper, tall building skyline
- For theme "deepest oceans" + title "Mariana Trench" + body "Pacific Ocean": deep ocean, dark abyss water, underwater trench
"""
